...
const Newsletter = () => {
	...
	const handleSubmit = (event) => {
		...
		const email = String(formData.get('newsletter') || '').trim();

		if (!email || !email.includes('@')) {
			return;
		}

		navigate('/newsletter/thanks', { state: { email } });
	};
				...
				<div className="container_relative">
					...
					<div className="img_caption">
						<div className="wrapper_column gap2">
							...
							<form className='form_group wrapper_column gap2' onSubmit={handleSubmit}>
								<div className="form_element relative">
									<input type="email" className='input_default' placeholder='Enter your mail' name="newsletter" id="newsletter" defaultValue="" required />
									<label htmlFor="newsletter" className='label_default'>
										<svg size="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
