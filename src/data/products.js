...
export const products = [
  ...
  },
  {
    ...
    category: "men",
    description: "Street-ready heritage running style. The Gel-Lyte III's split tongue design is instantly recognisable.",
    sizes: [40, 41, 42, 43, 44, 45],
    colors: ["White", "Black", "Sage"],
    features: [
      "Split-tongue construction",
  ...
  // ── WOMEN (additional) ────────────────────────────────────────────────────
  {
    ...
    features: [
      "Multi-layer gradient upper",
      "Forefoot + heel Air units",
      "Enclosure lacing system",
      "Waffle rubber outsole"
    ]
  },
  {
