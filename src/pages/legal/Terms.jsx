...
const Terms = () => (
  <>
    <PageMeta
      ...
      description="Sneakara's terms and conditions of sale."
      noIndex
    />
    <div className="min-h-screen bg-light">
      ...
      <div className="container max-w-3xl mx-auto px-6 py-16">
        ...
        <Section title="2. Products & Pricing">
          <p>All prices are in Euros (€) inclusive of French VAT (20%). Sneakara reserves the right to modify prices at any time. All items are guaranteed authentic.</p>
        </Section>
        ...
        <Section title="5. Right of Withdrawal">
          <p>Under French consumer law, you have <strong>14 days</strong> from receipt to withdraw from a purchase without reason. Items must be returned unused in original packaging. See our <Link to="/help/returns" className="text-brand hover:underline">Returns Policy</Link>.</p>
        </Section>
        ...
        <Section title="8. Dispute Resolution">
          <p>Contact us first at <a href="mailto:support@sneakara.com" className="text-brand hover:underline">support@sneakara.com</a>. If unresolved, you may refer the matter to the competent French courts or the EU Online Dispute Resolution platform.</p>
        </Section>
