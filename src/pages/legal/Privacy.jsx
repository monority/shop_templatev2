...
const Privacy = () => (
    <>
        <Helmet>
            <title>Privacy Policy · Sneakara</title>
            <meta name="description" content="Read Sneakara's privacy policy and how we handle your personal data." />
        </Helmet>
        <div className="min-h-screen bg-light">
            ...
            <div className="container max-w-3xl mx-auto px-6 py-16">
                <Section title="1. Who We Are">
                    <p>Sneakara SAS, registered in France (SIRET 000 000 000 00000), operates the website sneakara.com. For any privacy-related enquiry, contact us at <a href="mailto:privacy@sneakara.com" className="text-brand hover:underline">privacy@sneakara.com</a>.</p>
                </Section>
                ...
                <Section title="4. Data Retention">
                    <p>Account data is retained as long as your account is active. Order records are kept for 10 years as required by French accounting law. You may request deletion of your account at any time.</p>
                </Section>

                <Section title="5. Your Rights (RGPD)">
                    <p>Under the GDPR, you have the right to access, rectify, erase, restrict processing of, and port your personal data. You also have the right to object to processing and to lodge a complaint with the CNIL (Commission Nationale de l'Informatique et des Libertés).</p>
                    <p>To exercise your rights, email <a href="mailto:privacy@sneakara.com" className="text-brand hover:underline">privacy@sneakara.com</a>.</p>
                </Section>
