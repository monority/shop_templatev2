      ...
      <div className="container py-12">
        {items.length === 0 ? (
          <div className="text-center py-16">
            <div className="w-28 h-28 mx-auto mb-6 bg-gray-100 rounded-2xl flex items-center justify-center text-5xl">
              🛒
            </div>
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <h3 className="text-lg font-semibold text-dark mt-1">
                          {item.name}
                        </h3>
