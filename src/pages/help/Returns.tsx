...
const Returns = () => (
  <div className="min-h-screen bg-light">
    <PageMeta
      ...
      description="30-day hassle-free returns. Free return shipping within France. Refunds in 3–5 business days."
    />
    <div className="bg-dark text-white py-24 px-8 text-center">
      ...
      <p className="text-gray-300 text-xl max-w-2xl mx-auto">Not the right fit? No problem.</p>
    </div>

    <div className="container max-w-4xl mx-auto px-6 py-20 space-y-12">
      {/* Overview */}
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6" aria-label="Return highlights">
        {[
      ...
      <section aria-labelledby="eligibility">
        <h2 id="eligibility" className="text-3xl font-bold text-dark mb-4">Return Eligibility</h2>
        ...
        <ul className="space-y-2">
          {[
            ...
            <li key={item} className="flex items-center gap-3 text-gray-700">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-brand flex-shrink-0" aria-hidden="true">
      ...
      {/* How to return */}
      <section aria-labelledby="how-to-return">
        <h2 id="how-to-return" className="text-3xl font-bold text-dark mb-6">How to Return</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={step} className="card p-5 flex items-start gap-4">
              <div className="w-8 h-8 bg-brand text-white rounded-full flex items-center justify-center font-extrabold text-sm flex-shrink-0" aria-hidden="true">{step}</div>
              <div>
      ...
      <section aria-labelledby="exchanges">
        <h2 id="exchanges" className="text-3xl font-bold text-dark mb-4">Exchanges</h2>
