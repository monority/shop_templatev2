      ...
      <div className="container max-w-2xl mx-auto px-6 py-20">
        {submitted ? (
          <div className="card p-10 text-center">
            <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-brand mx-auto mb-4">
          ...
          <div className="card p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="orderId" className="block text-sm font-semibold text-dark mb-2">Order Number</label>
                <input
                  id="orderId"
                  type="text"
                  value={orderId}
              ...
              <div>
                <label htmlFor="trackEmail" className="block text-sm font-semibold text-dark mb-2">Email Address</label>
                <input
                  id="trackEmail"
                  type="email"
                  value={email}
              ...
              <button type="submit" className="btn btn-primary w-full">Track Order</button>
            </form>
          </div>
        )}
