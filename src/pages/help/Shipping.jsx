...
const Shipping = () => (
  <div className="min-h-screen bg-light">
    ...
    <div className="container max-w-4xl mx-auto px-6 py-20 space-y-12">
      {/* Methods */}
      <section>
        <h2 className="text-3xl font-bold text-dark mb-6">Delivery Options</h2>
      ...
      {/* Processing */}
      <section>
        <h2 className="text-3xl font-bold text-dark mb-4">Processing Time</h2>
      ...
      {/* Tracking */}
      <section>
        <h2 className="text-3xl font-bold text-dark mb-4">Tracking Your Order</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
          Once your order ships, you'll receive an email with a tracking number. You can also track your
          order at any time from the <a href="/help/track" className="text-brand hover:underline">Track Order</a> page.
        </p>
      </section>

      {/* International */}
      <section>
        <h2 className="text-3xl font-bold text-dark mb-4">International Shipping</h2>
        <p className="text-gray-600 leading-relaxed">
